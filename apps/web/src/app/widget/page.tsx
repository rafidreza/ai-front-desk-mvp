...
const consentVersion = 'pdpa-widget-v3';
      ...
      <section className="widget-frame" aria-label="Daemion web chat">
        ...
        {!hasConsent && (
          <div className="widget-consent" role="region" aria-label="Privacy consent">
            <p>
              By starting this chat, you agree to share your message and any contact details with
              this business so they can respond.
            </p>
