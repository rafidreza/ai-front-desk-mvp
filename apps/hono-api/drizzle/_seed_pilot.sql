...
VALUES
  ...
  ('kb-abc-3','pilot-abc','Coverage','Service is available in Dhaka and Chittagong city areas.',ARRAY['coverage','area','available','location','locations','service area','serve'],now(),now()),
