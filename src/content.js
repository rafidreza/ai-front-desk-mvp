...
export const legal = {
  privacy: {
    ...
    sections: [
      ['Scope', 'This Privacy Policy describes how Daemion processes personal data submitted through the public website, inquiry forms, careers applications, and direct correspondence, and personal data processed through the Daemion AI customer-support product, including messages received from connected Meta (Facebook Page and Messenger) and WhatsApp business accounts. For business clients, product engagements are additionally governed by separate data processing agreements.'],
      ...
      ['Messaging platform data (AI customer-support product)', 'When a business client connects its Facebook Page or Messenger account, and where applicable its WhatsApp business account, to the Daemion AI customer-support product, Daemion receives data through the Meta Platform APIs: the content of messages customers send to the connected Page or number, message attachments, the customer’s Meta-scoped sender ID (PSID), message timestamps, the connected Page and business identifiers, and the Page access token used to send replies. Page access tokens are stored encrypted and are deleted when the Page is disconnected.'],
      ['How messaging data is used and shared', 'Messaging data is used solely to generate AI-assisted replies, route conversations and support tickets to the business client, and operate the support service on the client’s behalf. For this data Daemion acts as a data processor for the business client, which is the controller of its own customers’ data. Message content may be processed by sub-processors that provide AI language models (for example, Anthropic accessed via OpenRouter) only to generate replies. Daemion does not sell messaging data, does not use it for advertising, and does not use it to build cross-business profiles. Messaging data is encrypted in transit and at rest and hosted on Cloudflare and a managed PostgreSQL database.'],
      ...
      ['Retention', 'Inquiry submissions are retained for 24 months from receipt. Careers materials are retained for 12 months from role close unless the candidate consents to longer retention. Web server logs are retained for 90 days, then aggregated or deleted. Messaging conversation data processed through the AI customer-support product is retained for the duration of the business client’s engagement and is deleted on request or on account closure, subject to the applicable data processing agreement.'],
  ...
  'data-deletion': {
    slug: 'data-deletion',
    title: 'Data Deletion',
    description: 'How to request deletion of personal data submitted to Daemion through the public website, inquiry surfaces, careers channels, and the Daemion AI customer-support product (Facebook Messenger and WhatsApp).',
    note: 'Version 1.0. Pending Bangladesh-qualified legal review before final production use.',
    sections: [
      ['Who may request deletion', 'Individuals may request deletion of personal data they submitted directly to Daemion or that Daemion processes in connection with public website, inquiry, careers, or correspondence surfaces. Customers who messaged a business that uses the Daemion AI customer-support product may also request deletion of their Facebook Messenger or WhatsApp conversation data held by Daemion.'],
      ['Messaging platform data (Facebook, Messenger, WhatsApp)', 'To delete conversation data received through a connected Facebook Page or WhatsApp business account, write to privacy@daemion.com with the subject line Data deletion request and the Meta-scoped sender ID or the customer name and approximate dates, or ask the business you messaged to submit the request on your behalf. When a business disconnects its Facebook Page from Daemion, the stored Page access token and that page’s stored conversation data are deleted.'],
