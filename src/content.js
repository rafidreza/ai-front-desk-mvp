...
export const legal = {
  privacy: {
    ...
    sections: [
      ['Scope', 'This Privacy Policy describes how Daemion processes personal data submitted through the public website, inquiry forms, careers applications, and direct correspondence. Product engagements operate under separate data processing agreements.'],
      ...
      ['Why Daemion processes data', 'Daemion processes data to respond to inquiries, evaluate careers applications, operate and secure the site, comply with legal obligations, and maintain institutional records where appropriate.'],
      ['Retention', 'Inquiry submissions are retained for 24 months from receipt. Careers materials are retained for 12 months from role close unless the candidate consents to longer retention. Web server logs are retained for 90 days, then aggregated or deleted.'],
  ...
  'data-deletion': {
    slug: 'data-deletion',
    title: 'Data Deletion',
    description: 'How to request deletion of personal data submitted to Daemion through the public website, inquiry surfaces, and careers channels.',
    note: 'Version 1.0. Pending Bangladesh-qualified legal review before final production use.',
    sections: [
      ['Who may request deletion', 'Individuals may request deletion of personal data they submitted directly to Daemion or that Daemion processes in connection with public website, inquiry, careers, or correspondence surfaces.'],
